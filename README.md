For this project, I made a psychic game. The app randomly picks a letter, and the user has to guess which letter the app chose. 

The following shows on the page:
